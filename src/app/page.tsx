...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col h-screen p-4 sm:p-6 lg:p-8 font-sans bg-gradient-to-br from-[#EBF4DD] via-[#90AB8B] to-[#5A7863] dark:bg-neutral-950 animate-gradient-xy relative selection:bg-[#90AB8B]/30 selection:text-emerald-900 overflow-hidden transition-colors duration-500">
